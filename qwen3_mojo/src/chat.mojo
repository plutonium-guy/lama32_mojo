"""Interactive chat REPL: Qwen3-0.6B on Metal, weights load once.

Tokenizer via HF tokenizers (apply_chat_template). Inference is the Mojo GPU
stack in qwen_gpu.mojo with persistent KV cache.
...
def generate(mut model: Qwen, tok: PythonObject, ids: List[Int],
